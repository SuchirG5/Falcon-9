...
{
    //variables
    private double rocketMass = 1420788;
    private double netForce = 0;
    private double altitude;
    private double time = 0;
    private double acceleration = 0;
    private double burnTime = 154;
    private double burnTimeS2 = 397;

    //constants
    private double dt;
    private double dm = 8438.58;
    ...
    public FalconHeavy(int xPos, int yPos, int ySpeed, int width, int height, double dt)
    {
